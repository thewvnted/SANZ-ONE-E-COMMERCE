...
if (isset($_POST['login'])) {
    ...
    $verification_code = $_POST['verification_code']; // Changed variable name
...
<form class="form" method="post" action="userlogin.php">
    ...
    <div class="field">
        ...
        <input autocomplete="off" placeholder="Username" class="input-field" type="text" name="user-name">
    </div>
    <div class="field">
        <svg class="input-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
            <path d="M8 1a2 2 0 0 1 2 2v4H6V3a2 2 0 0 1 2-2zm3 6V3a3 3 0 0 0-6 0v4a2 2 0 0 0-2 2v5a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"></path>
        </svg>
        <input placeholder="Verfication Code" class="input-field" type="password" name="verification_code">
    </div>
    <div class="btn">
