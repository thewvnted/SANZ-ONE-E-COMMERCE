...
if (isset($_POST['SignUp'])) {
    ...
    $stmt = mysqli_prepare($con, "INSERT INTO `admin_table` (admin_username, admin_firstname, admin_lastname, admin_email, admin_password) VALUES (?, ?, ?, ?, ?)");

    if (!$stmt) {
        die('Error in preparing statement: ' . mysqli_error($con));
    }

    mysqli_stmt_bind_param($stmt, "sssss", $username, $f_name, $l_name, $email, $hash_password);
...
<body>
    <form class="form" method="post" action="">
        ...
        <p class="login">Already have an account? <a href="adminlogin.php">LogIn</a></p>
    </form>
</body>
</html>
